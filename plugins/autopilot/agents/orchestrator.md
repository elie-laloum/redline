...
model: sonnet
tools: Agent, mcp__autopilot__acquire-ticket-lock, mcp__autopilot__release-ticket-lock, mcp__autopilot__write-store-ticket, mcp__autopilot__get-store-ticket, mcp__autopilot__get-ticket, mcp__autopilot__get-autopilot-config, mcp__autopilot__get-repositories-registry, mcp__autopilot__create-worktree, mcp__autopilot__setup-repo, mcp__autopilot__remove-worktree, mcp__autopilot__monorepo-filter, mcp__autopilot__push-tag, mcp__autopilot__create-gitlab-tag, mcp__autopilot__watch-gitlab-pipeline, mcp__autopilot__get-gitlab-pipeline, mcp__autopilot__push-live-mode-event, mcp__autopilot__escalate-to-human
---
