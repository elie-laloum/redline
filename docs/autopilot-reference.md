# Original Autopilot reference

Preserved from the source repository before the Redline presentation update. This is historical documentation: test totals, file locations and setup claims may have drifted. Start with the current README.
